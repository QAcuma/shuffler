...
public enum EventConstant implements EventConstantButton {
    ...
    RED_CHECKING_MESSAGE("\n" + RED_CIRCLE_EMOJI + "   Победа красных?   " + RED_CIRCLE_EMOJI),
    BLUE_CHECKING_MESSAGE("\n" + BLUE_CIRCLE_EMOJI + "   Победа синих?   " + BLUE_CIRCLE_EMOJI),
